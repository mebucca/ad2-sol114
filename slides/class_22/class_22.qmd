...
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-color: "#C80815"
---

# Tablas de contingencia {background-color="#007FFF" .inverse .center .middle}
...
::: {.pull-right}
<br> <br>
- Este tipo de tablas se denomina [tablas de contingencia]{.bold}
...
## Estructura probabilística {background-color="#007FFF" .inverse .center .middle .section-title}
...
## Distribuciones condicionales {background-color="#007FFF" .inverse .center .middle .section-title}

## Distribuciones condicionales 

<br>

- Recuerden que $\mathbb{P}(Y=y \mid X=x)$ es la [probabilidad condicional]{.bold} de que la variable $Y$ dado $X$.

. . .

- La [distribución condicional]{.bold} $f(y \mid x)$ es una función que expresa la probabilidad que $Y$ tome cada uno de sus posibles valores $y$'s si X toma cualquiera los valores $x$'s.
...
- Si $X \bot Y$ las probabilidades conjuntas [esperadas bajo el supuesto de independencia]{.bold} están dadas por el producto de las distribuciones marginales:
...
[¿Se parece la distribución observada a la distribución que observariamos si voto e ingresos no estuvieran asociados?]{.bold}

## Hasta la próxima clase. Gracias! {background-color="#007FFF" .inverse .center .middle}
