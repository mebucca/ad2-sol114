...
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-color: "#ff7377"
---

## Distribuciones Continuas {background-color="#ffec73" .inverse .center .middle}
### Intuición
...
::: {.pull-right}
[Función de densidad probabilistica (PDF):]{.bold}

\begin{align}
f(x) = 
  \begin{cases} 
   \frac{1}{b-a} & \text{si } \quad a \leq x \leq b  \\
   0       &  x < a \quad \text{  o } \quad x > b
  \end{cases}
\end{align}

<br>
En este caso $a=25$ y $b=30$.
:::
...
$f(27.354)$ = 1/(30-25) = `r round(1/5,2)` 
...
[Probabilidad de un intervalo:]{.bold}
...
::: {.pull-right}
[Función de densidad probabilistica (PDF) de una distribución normal:]{.bold}
...
::: {.pull-right}
[Función de distribución acumulada (CDF) de una distribución normal:]{.bold}
...
[Probabilidad en un intervalo:]{.bold}
...
## {background-color="#ffec73" .inverse .center .middle}
