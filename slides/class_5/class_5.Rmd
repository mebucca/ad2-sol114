...
plot <- ggplot(data = mydata, mapping = aes(x = x)) +
  ...
  labs(y="f(y)", x="y", title="Probability function Chi^2 con df=1") +
     scale_color_viridis_d() +
      ...
      annotate(geom="text", x=our_chi2+1.5, y=3.7, label=expression(paste(hat(t)," = 1.56")), color="black", parse=TRUE, size=8) 
