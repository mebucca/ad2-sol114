...
# Test de Hipótesis en dos muestras {background-color="#ADD8E6" .inverse .center .middle}
...
Por tanto, $(\bar{X}_{H} - \bar{X}_{M}) = \\
 \text{Normal}\big(\mu_H, \frac{\sigma_H}{\sqrt{n_H}}\big) -  \text{Normal}\big(\mu_M, \frac{\sigma_M}{\sqrt{n_M}}\big) \sim  \text{Normal}\Bigg(\mu_H - \mu_M, \sqrt{\frac{\sigma^{2}_H}{n_H} + \frac{\sigma^{2}_M}{n_M}} \quad \Bigg)$ 
