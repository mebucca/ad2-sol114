...
&= \mathbb{E}[ \ (Z_X - \mathbb{E}[Z_X]) \ (Z_Y  - \mathbb{E}[Z_Y]) \ ] \\ \\
...
Por supuesto, aquí tienes una versión revisada que incluye el rango de variación del coeficiente de correlación:
