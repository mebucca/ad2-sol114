...
Establece hipótesis de trabajo y dividir el espacio entre dos particiones mutaamente excluyentes:
...
.bold[Paso #4:] Derivar la distribución de referencia (o nula)
...
- El estadístico  $\delta: \bar{Y}_{U} - \bar{Y}_{\neg U}$ entregará un número $\approx 0$
    - con varianciones de muestra a muestra
    
--

- ¿Cual es distribución muestral del estadístico $\delta$?
