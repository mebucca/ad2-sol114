...
library(cowplot)
style_duo_accent(
  primary_color   = "#00634E",   # Werder Bremen green (main jersey/emblem)
  secondary_color = "#003E30",   # Dark forest green (shadow/depth)
  background_color = "#F5F5F5",  # Soft white (clean, avoids slide glare)
  header_font_google = google_font("Archivo"),
  text_font_google   = google_font("Inconsolata"),
  link_color = "#E37222"         # Accent orange (historic kit/crest detail)
)
