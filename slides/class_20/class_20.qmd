...
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-color: "#6CABDD"
---

# Test de Hipótesis en dos muestras {background-color="#1C2C5B" .inverse .center .middle}
...
## Test de Permutación {background-color="#1C2C5B" .inverse .center .middle .section-title}
...
Las Pruebas de Permutación son una herramienta útil para realizar pruebas de hipótesis.
...
[Contexto:]{.bold} queremos comparar los grupos A y B en alguna dimensión.
...
::: {.pull-right}
[Diferencia con datos permutados:]{.bold}
...
[Ejecutamos 100,000 permutaciones y guardamos resultados:]{.bold}
...
## Hasta la próxima clase. Gracias! {background-color="#1C2C5B" .inverse .center .middle}
