...
style_duo_accent(primary_color = "#63415a", secondary_color = "#1f2026",
...
.pull-left[
.bold[Rebeca Orellana]

- Socióloga Universidad de Chile

- Estudiante Magíster en Sociología UC

- Investigación:  Dinámicas en internet, movimientos sociales, opinión pública

- Métodos: Redes, procesamiento de lenguaje natural, teoría fundada.
...
- Investigación:  Orientación a la dominancia social en personas mapuches y no- mapuches.

- Métodos: Ecuaciones estructurales y modelos de efectos fijos.
...
## Filosofía de enseñanza de métodos cuantitativos
