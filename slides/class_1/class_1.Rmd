---
title: "Probabilidad e Inferencia Estadística (SOL114)"
subtitle: "Clase #1: Fundamentos de Teoría de la Probabilidad"
...
style_duo_accent(primary_color = "#33583a", secondary_color = "#ee592c",
                 white_color = lighten_color("#ee592c", 0.9),
                 black_color = darken_color("#33583a", 0.3),
                 background_color = "#f8f7f3",
                 header_font_google = google_font("Fira Sans"),
                 text_font_google   = google_font("Slabo 27px"), 
                 link_color="#7ed694"
