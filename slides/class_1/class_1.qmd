...
## Fundamentos de Probabilidades {background-color="#FF4500" .inverse .center .middle .section-title}
...
## Hasta la próxima clase. Gracias! {background-color="#FF4500" .inverse .center .middle}
