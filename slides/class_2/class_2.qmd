...
## Probabilidades condicional {background-color="#6fbbca" .inverse .center .middle}
...
## Teorema de Bayes {background-color="#6fbbca" .inverse .center .middle}
...
## Ley de "probabilidad total" {background-color="#6fbbca" .inverse .center .middle}
...
## Independencia estadística {background-color="#6fbbca" .inverse .center .middle}
...
## {background-color="#6fbbca" .inverse .center .middle}
