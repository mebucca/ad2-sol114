...
Para 4.25 horas: $$Z_1 = \frac{4.25 - 5}{0.75} = -1$$

Para 5.75 horas: $$Z_2 = \frac{5.75 - 5}{0.75} = 1$$

Luego, utilizamos las funciones Φ(Z) para encontrar las proporciones correspondientes:

$$P(-1 < Z < 1) = \Phi(1) - \Phi(-1)$$

Consultando una tabla de valores Z o usando una calculadora, encontramos que 

$$P(-1 < Z < 1) ≈ 0.8413447 - 0.1586553 ≈ 0.6826894$$
