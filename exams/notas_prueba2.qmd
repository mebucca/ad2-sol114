...
# Data preparation
data_long <- data_grades %>%  select(Rut,`I.1`:`II.3`) %>%
  pivot_longer(cols = `I.1`:`II.3`, names_to = "Variable", values_to = "Value")
