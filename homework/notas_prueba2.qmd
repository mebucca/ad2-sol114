...
Las notas fueron re-escaladas para final el 7 en la nota máxima obtenida. Formalmente:
...
Comparando el rendimiendo en las Prueba 1 y Prueba 2, observamos que un `r 100* round(mean( data_combined$Nota_2 > data_combined$Nota_1, na.rm=T),2)`% de los estudiantes mejoró su nota. Adicionalmente, existe una asociación positiva pero relativamente débil entre ambas.
