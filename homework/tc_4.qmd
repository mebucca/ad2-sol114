...
*Nota:* Responder la pregunta bonus NO es un requisito necesario para obtener puntaje completo. Responder incorrectamente la pregunta bonus NO afectará negativamente la nota obtenida, pero responderla correctamente mejorará la nota obtenida en un máximo de 1 punto (o en la cantidad necesaria para obtener nota máxima si la nota original fuera superior a 6)
