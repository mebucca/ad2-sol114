...
$$S = \{(Cara, 1), (Cara, 2), \ldots, (Cara, 6), (Sello, 1), (Sello, 2), \ldots, (Sello, 6)\}$$
...
- Percentil es el valor que estás tratando de encontrar.
- μ es la media de la distribución de la media muestral (\$45,000).
- Z es la puntuación Z correspondiente al percentil deseado.
- σx̄ es la desviación estándar de la distribución de la media muestral (\$80).
