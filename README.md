...
| 21   | Agosto     | Distribuciones continuas: Uniforme y Normal            |                                                                         |      6.3.4         |
| 26   | Agosto     | Momentos: valor esperado & varianza                    |                                                                         |      6.3.5        |
...
| 25   | Septiembre | Distribución muestral de un estimador                  |                                                                         |    7.1.1 & 7.1.2          |
| 30   | Septiembre | Distribución muestral via Experimento Monte Carlo      |                                                                         |              |
| 2    | Octubre    | Estimación de intervalos & intervalos de confianza     |                                                                         |  7.1.3 & 7.1.4            |
| 7    | Octubre    | IC: ejemplos tradeoff entre precisión y confianza      |                                                                         |  7.1.3 & 7.1.4          |
| 9    | Octubre    | IC para media y proporción muestral                    |                                                                         |   7.1.3 & 7.1.4           |
| 14   | Octubre    | IC con varianza desconocida & margen de error          |                                                                         |  7.1.3 & 7.1.4            |
| 16   | Octubre    | Estimación de IC via método de Bootstrap               |                                                                         |        |
| 21   | Octubre    | Test de hipótesis: paradigma Fisher & Neyman-Pearson   |                                                                         |  7.2.2            |
| 28   | Octubre    | Test de media/proporción en una muestra                           |                                                              |   7.2.3   |
| 30   | Octubre    | Test de media/proporción en dos muestras               |                                                                         |   7.2.4           |
| 4    | Noviembre  | Test de hipótesis via Test de Permutaciones            |                                                                         |              |
| 6    | Noviembre  | PRUEBA II                                              |                                                                         |              |
| 11   | Noviembre  | Asociación estadística y causalidad                    |                                                                         |    2          |
...
| Tarea corta 3  | 26 agosto     | 2 septiembre | [`[TC3]`](https://mebucca.github.io/ad2-sol114/homework/tc_3#1) [`[TC3.qmd]`](homework/tc_3.qmd) |
